...
const BUDGET_LINE_COLUMNS =
  "id, budget_version_id, kind, description_status, description_text, external_code, parent_line_id, position, scope_kind, scope_procurement_lot_id, total_cents, quantity_decimal, unit, official_unit_price_cents, metadata";
