...
// explicitamente autorizado — ver README.md nesta pasta ("Ambiente:
// compartilhado controlado, não dedicado"; o estado atual é compartilhado
// controlado, um projeto separado continua sendo a opção preferencial).
// Roda via
