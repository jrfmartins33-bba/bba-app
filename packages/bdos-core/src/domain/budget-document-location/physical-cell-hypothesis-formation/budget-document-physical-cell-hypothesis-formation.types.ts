...
import type { BudgetDocumentPhysicalColumnHypothesisReconstructionResult, PhysicalColumnHypothesisReconstructionGroupStatus, PhysicalColumnHypothesisReconstructionPageStatus, PhysicalColumnHypothesisReconstructionRegionStatus, PhysicalColumnHypothesisSegmentDisposition } from "../physical-column-hypothesis-reconstruction/budget-document-physical-column-hypothesis-reconstruction.types";
...
export type PhysicalCellHypothesisSegmentDisposition =
  ...
  | { readonly status: "unresolved_upstream_region_not_processable"; readonly segmentKey: string; readonly lineKey: string; readonly sourcePhysicalColumnHypothesisRegionStatus: PhysicalColumnHypothesisReconstructionRegionStatus; readonly upstreamDispositionStatus: PhysicalColumnHypothesisSegmentDisposition["status"] }
  | { readonly status: "unresolved_inherited_physical_column_hypothesis_failure"; readonly segmentKey: string; readonly lineKey: string; readonly upstreamFailedPhase: "band_construction" | "hypothesis_formation"; readonly upstreamDispositionStatus: "unresolved_physical_column_hypothesis_detection_failed" }
...
export interface RegionPhysicalCellHypothesisFormationMetrics {
  ...
  readonly totalRegionSegmentCount: number; readonly includedSegmentCount: number; readonly outsideSegmentCount: number; readonly inheritedAmbiguousSegmentCount: number; readonly partialIntersectionSegmentCount: number; readonly multipleClaimSegmentCount: number; readonly sourceContractInconsistentSegmentCount: number; readonly upstreamRegionNotProcessableSegmentCount: number; readonly inheritedPhysicalColumnHypothesisFailureSegmentCount: number; readonly formationFailedSegmentCount: number;
...
export interface PagePhysicalCellHypothesisFormationMetrics { readonly totalRegionCount: number; readonly formedRegionCount: number; readonly formedWithAmbiguitiesRegionCount: number; readonly formedWithProblemsRegionCount: number; readonly gridWithoutCellHypothesesRegionCount: number; readonly noPhysicalGridRegionCount: number; readonly regionNotProcessableCount: number; readonly gridIntersectionCount: number; readonly emptyGridIntersectionCount: number; readonly cellHypothesisCount: number; readonly multiSegmentCellHypothesisCount: number; readonly segmentCount: number; readonly includedSegmentCount: number; readonly upstreamRegionNotProcessableSegmentCount: number; readonly inheritedPhysicalColumnHypothesisFailureSegmentCount: number; readonly ambiguousSegmentCount: number; readonly formationFailedSegmentCount: number; readonly technicalProblemCount: number; }
...
export interface PhysicalCellHypothesisFormationRegion { readonly regionProcessedKey: string; readonly sourceRegionKey: string; readonly pageNumber: number; readonly sourcePhysicalColumnHypothesisRegionStatus: PhysicalColumnHypothesisReconstructionRegionStatus; readonly status: PhysicalCellHypothesisFormationRegionStatus; readonly gridIntersections: ReadonlyArray<PhysicalGridIntersection>; readonly cellHypotheses: ReadonlyArray<PhysicalCellHypothesis>; readonly segmentDispositions: ReadonlyArray<PhysicalCellHypothesisSegmentDisposition>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: RegionPhysicalCellHypothesisFormationMetrics; readonly profileId: string; readonly profileVersion: number; }
export interface PhysicalCellHypothesisFormationPage { readonly pageProcessedKey: string; readonly pageNumber: number; readonly sourcePhysicalColumnHypothesisPageStatus: PhysicalColumnHypothesisReconstructionPageStatus; readonly status: PhysicalCellHypothesisFormationPageStatus; readonly regions: ReadonlyArray<PhysicalCellHypothesisFormationRegion>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: PagePhysicalCellHypothesisFormationMetrics; }
export interface PhysicalCellHypothesisFormationGroup { readonly groupProcessedKey: string; readonly sourceCandidateGroupKey: string; readonly sourcePhysicalColumnHypothesisGroupStatus: PhysicalColumnHypothesisReconstructionGroupStatus; readonly status: PhysicalCellHypothesisFormationGroupStatus; readonly pageKeys: ReadonlyArray<string>; readonly pages: ReadonlyArray<PhysicalCellHypothesisFormationPage>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: GroupPhysicalCellHypothesisFormationMetrics; }
