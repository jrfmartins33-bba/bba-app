...
export interface PhysicalCellHypothesisFormationRegion { readonly regionProcessedKey: string; readonly sourceRegionKey: string; readonly pageNumber: number; readonly sourcePhysicalColumnHypothesisRegionStatus: string; readonly status: PhysicalCellHypothesisFormationRegionStatus; readonly gridIntersections: ReadonlyArray<PhysicalGridIntersection>; readonly cellHypotheses: ReadonlyArray<PhysicalCellHypothesis>; readonly segmentDispositions: ReadonlyArray<PhysicalCellHypothesisSegmentDisposition>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: RegionPhysicalCellHypothesisFormationMetrics; readonly profileId: string; readonly profileVersion: number; }
export interface PhysicalCellHypothesisFormationPage { readonly pageProcessedKey: string; readonly pageNumber: number; readonly sourcePhysicalColumnHypothesisPageStatus: string; readonly status: PhysicalCellHypothesisFormationPageStatus; readonly regions: ReadonlyArray<PhysicalCellHypothesisFormationRegion>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: PagePhysicalCellHypothesisFormationMetrics; }
export interface PhysicalCellHypothesisFormationGroup { readonly groupProcessedKey: string; readonly sourceCandidateGroupKey: string; readonly sourcePhysicalColumnHypothesisGroupStatus: string; readonly status: PhysicalCellHypothesisFormationGroupStatus; readonly pageKeys: ReadonlyArray<string>; readonly pages: ReadonlyArray<PhysicalCellHypothesisFormationPage>; readonly technicalProblems: ReadonlyArray<PhysicalCellHypothesisFormationTechnicalProblem>; readonly metrics: GroupPhysicalCellHypothesisFormationMetrics; }
